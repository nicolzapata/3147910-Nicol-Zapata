...
namespace SistemaEscolar.Controllers
{
    ...
    public class EstudiantesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdEstudiante,Documento,Nombres,Apellidos,Correo,Telefono,FechaRegistro")] Estudiante estudiante)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdEstudiante,Documento,Nombres,Apellidos,Correo,Telefono,FechaRegistro")] Estudiante estudiante)
        {
